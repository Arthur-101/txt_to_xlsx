...
root = tk.Tk()
root.title("Student's Grades Sheet")
...
export_image = PhotoImage(file='export.png')
...
def import_file_x():
    ...
    if file_path_x:
        try:
            ...
            tabview_x.add(tab2, text="Ana 1")
            tabview_x.add(tab3, text="Ana 2")
            tabview_x.add(tab4, text="Ana 3")
            ...
            #############################    TAB 3    ###################################
            analysis2_tab(tab3, dataframe_Subject_percentage_count_df_X)
            
            #############################    TAB 4    ###################################
            analysis3_tab(tab4, dataframe_highest_marks_df_X)
...
def import_file_xii():
    ...
    if file_path_xii:
        try:
            ...
            tabview_xii.add(tab6, text="Ana 1")
            tabview_xii.add(tab7, text="Ana 2")
            tabview_xii.add(tab8, text="Ana 3")
            ...
            #############################    TAB 7    ###################################
            analysis2_tab(tab7, dataframe_Subject_percentage_count_df_Xii)
            
            #############################    TAB 8    ###################################
            analysis3_tab(tab8, dataframe_highest_marks_df_Xii)
