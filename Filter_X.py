...
class DataProcessor_X:
    ...
    def process_data(self):
        ...
        self.school_code = int(school_match.group(1) if school_match else "")
    ...
    def calculate_percentage_counts_plot(self):
        ...
        plt.savefig('Items/x_analysis_graph1.png')
    ...
    def calculate_subject_percentage_counts(self):
        ...
        for s_code in sub_codes:
            ...
            non_empty_values = pd.to_numeric(non_empty_values, errors='coerce')
    ...
    def calculate_subject_percentage_counts_plot(self):
        ...
        plt.savefig('Items/x_analysis_graph2.png')
    ...
    def calculate_highest_marks_students_plot(self):
        ...
        plt.savefig('Items/x_analysis_graph3.png')
...
if __name__ == "__main__":
    ...
    data_processor = DataProcessor_X(input_file)
